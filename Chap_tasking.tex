...
Worksharing constructs (e.g. \code{for}, \code{do}, \code{single} constructs) do this, too; 
but the work units are tightly controlled by an iteration limit and limited 
scheduling, or a limited number of \code{single} regions. Worsharing was designed 
...
hierarchy of tasks, see example 4 and 7  below). A \code{taskloop} construct
...
to the task.  Users can introduce scheduling points with the \code{taskyield}
