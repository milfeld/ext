...
for accessing in the second \code{target} region. At the end of the second \code{target} region, the data 
...
(See the restrictions for the \code{map} clause in Section 2.15.5.1 of the specification.)
